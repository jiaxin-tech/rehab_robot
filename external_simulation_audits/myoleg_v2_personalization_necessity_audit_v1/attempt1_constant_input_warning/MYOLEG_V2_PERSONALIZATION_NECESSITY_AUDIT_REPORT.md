...
Thirty preregistered descriptive Spearman tests were run across six frozen parameters and five oracle/gap outcomes. Associations with BH q<0.05: **0**. These are exploratory associations only; no predictive model was trained and no cohort or range was changed.
