...
class PyRTmotioncontrol5:
    ...
    用于在python中使用实时接口
    """
    def MoveC(self, speed: typing.SupportsFloat, start: xCoreSDK_python.CartesianPosition, aux: xCoreSDK_python.CartesianPosition, target: xCoreSDK_python.CartesianPosition) -> None:
        """
        ...
        """
    def MoveJ(self, speed: typing.SupportsFloat, start: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(5)"], target: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(5)"]) -> None:
        """
        ...
        """
    def MoveL(self, speed: typing.SupportsFloat, start: xCoreSDK_python.CartesianPosition, target: xCoreSDK_python.CartesianPosition) -> None:
        """
    ...
    def sendCommand(self, cmd: xCoreSDK_python.Torque) -> None:
        ...
        Raises:
            ...
            RealtimeControlException: 命令发送网络异常; 或命令类型与控制模式不匹配; 或控制器执行已发送命令时发生错误
        """
    def setCartesianImpedance(self, factor: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(6)"], ec: dict) -> None:
        """
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setCartesianImpedanceDesiredTorque(self, torque: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(6)"], ec: dict) -> None:
        """
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setCartesianLimit(self, lengths: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], frame: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(16)"], ec: dict) -> None:
        """
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setCollisionBehaviour(self, torqueThresholds: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(5)"], ec: dict) -> None:
        """
        设置碰撞检测阈值。
        ...
        """
    @typing.overload
    def setControlLoop(self: ..., callback: collections.abc.Callable[[], xCoreSDK_python.JointPosition], priority: typing.SupportsInt = 0, useStateDataInLoop: bool = False) -> None:
        ...
    @typing.overload
    def setControlLoop(self: ..., callback: collections.abc.Callable[[], xCoreSDK_python.CartesianPosition], priority: typing.SupportsInt = 0, useStateDataInLoop: bool = False) -> None:
        ...
    @typing.overload
    def setControlLoop(self: ..., callback: collections.abc.Callable[[], xCoreSDK_python.Torque], priority: typing.SupportsInt = 0, useStateDataInLoop: bool = False) -> None:
        ...
    def setControlLoopCar(self, callback: collections.abc.Callable[[], xCoreSDK_python.CartesianPosition], priority: typing.SupportsInt = 0, useStateDataInLoop: bool = False) -> None:
        """
        开始执行回调函数。
        ...
        """
    def setControlLoopJoi(self, callback: collections.abc.Callable[[], xCoreSDK_python.JointPosition], priority: typing.SupportsInt = 0, useStateDataInLoop: bool = False) -> None:
        """
        开始执行回调函数。
        ...
        Args:
            ...
            useStateDataInLoop (bool): 是否需要在周期内读取状态数据。
        """
    def setControlLoopTor(self, callback: collections.abc.Callable[[], xCoreSDK_python.Torque], priority: typing.SupportsInt = 0, useStateDataInLoop: bool = False) -> None:
        """
        开始执行回调函数。
        ...
        Args:
            ...
            useStateDataInLoop (bool): 是否需要在周期内读取状态数据。
        """
    def setEndEffectorFrame(self, frame: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(16)"], ec: dict) -> None:
        """
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setFcCoor(self, frame: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(16)"], type: xCoreSDK_python.FrameType, ec: dict) -> None:
        """
        设置机器人力控坐标系。
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setFilterFrequency(self, jointFrequency: typing.SupportsFloat, cartesianFrequency: typing.SupportsFloat, torqueFrequency: typing.SupportsFloat, ec: dict) -> None:
        """
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setFilterLimit(self, limit_rate: bool, cutoff_frequency: typing.SupportsFloat) -> bool:
        """
        设置限幅滤波参数。
        ...
        Returns:
            bool: true - 设定成功
        """
    def setJointImpedance(self, factor: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(5)"], ec: dict) -> None:
        """
    ...
    def setLoad(self, load: xCoreSDK_python.Load, ec: dict) -> None:
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setServoJoint(self, ServoJ_T: typing.SupportsFloat, ServoJ_Lookahead: typing.SupportsFloat, ServoJ_Kp: typing.SupportsFloat, ec: dict) -> None:
        """
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setTorqueFilterCutOffFrequency(self, frequency: typing.SupportsFloat, ec: dict) -> None:
        """
        设置滤波参数。
...
class PyRTmotioncontrol6:
    ...
    def MoveC(self, speed: typing.SupportsFloat, start: xCoreSDK_python.CartesianPosition, aux: xCoreSDK_python.CartesianPosition, target: xCoreSDK_python.CartesianPosition) -> None:
        ...
        Raises:
            ...
            RealtimeMotionException: 机器人运动过程中发生错误
        """
    def MoveJ(self, speed: typing.SupportsFloat, start: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(6)"], target: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(6)"]) -> None:
        """
        MoveJ指令，上位机规划路径，在到达target之前处于处于阻塞状态。如果运动中发生错误将停止阻塞状态并返回。
    ...
    def setCartesianLimit(self, lengths: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], frame: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(16)"], ec: dict) -> None:
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setCollisionBehaviour(self, torqueThresholds: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(6)"], ec: dict) -> None:
        """
        设置碰撞检测阈值。
    ...
    def setFilterLimit(self, limit_rate: bool, cutoff_frequency: typing.SupportsFloat) -> bool:
        ...
        Returns:
            bool: true - 设定成功
        """
    def setJointImpedance(self, factor: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(6)"], ec: dict) -> None:
        """
        设置轴空间阻抗控制系数，轴空间阻抗运动时生效。
...
class PyRTmotioncontrol7:
    ...
    def MoveC(self, speed: typing.SupportsFloat, start: xCoreSDK_python.CartesianPosition, aux: xCoreSDK_python.CartesianPosition, target: xCoreSDK_python.CartesianPosition) -> None:
        ...
        Raises:
            ...
            RealtimeMotionException: 机器人运动过程中发生错误
        """
    def MoveJ(self, speed: typing.SupportsFloat, start: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(7)"], target: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(7)"]) -> None:
        """
        MoveJ指令，上位机规划路径，在到达target之前处于处于阻塞状态。如果运动中发生错误将停止阻塞状态并返回。
    ...
    def setCartesianLimit(self, lengths: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], frame: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(16)"], ec: dict) -> None:
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setCollisionBehaviour(self, torqueThresholds: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(7)"], ec: dict) -> None:
        """
        设置碰撞检测阈值。
    ...
    def setFilterLimit(self, limit_rate: bool, cutoff_frequency: typing.SupportsFloat) -> bool:
        ...
        Returns:
            bool: true - 设定成功
        """
    def setJointImpedance(self, factor: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(7)"], ec: dict) -> None:
        """
        设置轴空间阻抗控制系数，轴空间阻抗运动时生效。
