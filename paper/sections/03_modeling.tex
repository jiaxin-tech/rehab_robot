...
$L_1=\SI{0.42}{m}$ and $L_2=\SI{0.30}{m}$.  The formal experiment protocol
ROM\_PROTOCOL\_V2 constrains hip flexion to $0$--$120^{\circ}$ and knee flexion
to $5$--$145^{\circ}$.  Earlier $5$--$130^{\circ}$ outputs are retained only as
historical development evidence and are not inputs to the active pipeline.
...
A naturally repeating cycle was selected from the measured sequence using
joint-state and endpoint-closure criteria.  Both measured flexion and measured
extension branches were preserved.  Only a small periodic smoothing
correction was introduced to obtain a repeatable $C^2$ trajectory.  The frozen
slow timing assigns \SI{13.6}{s} to flexion and \SI{10.4}{s} to extension.
