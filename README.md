...
当前核心集合为 37 个测试文件，已验证 **333 passed**。它覆盖当前离线研究、采集、fake SDK 和诊断代码；不连接机器人，也不是历史全仓套件。环境版本与验证记录见[上手指南](docs/GETTING_STARTED.md)。
...
| `lower_limb_sim/` | 下肢力学、轨迹、五参数估计、V3/E2 与独立 E3 实验 |
